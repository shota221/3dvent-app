...
class VentilatorDataUpdateViewModel(
    ...
    val serialNumber:MutableLiveData<String> by lazy {
        MutableLiveData()
    }
    val startUsingAt:MutableLiveData<String> by lazy {
        MutableLiveData()
    }

    fun onClickSaveVentilatorDataButton() {
        transitionToVentilatorDataDetail.value = Event("transitionToVentilatorDataDetail")
    }
